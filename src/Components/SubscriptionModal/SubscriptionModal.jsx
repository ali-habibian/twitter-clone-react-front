...
export default function SubscriptionModal({ open, handleClose }) {
    ...
    const [paln, setPlan] = React.useState("Annually");
                        ...
                        <div className='w[80%] space-y-10'>
                            <div className='p-5 rounded-md flex items-center justify-between shadow-lg bg-slate-400'>
                                <h1 className='text-xl pr-5'>
                                    Blue subscription with a verified phone number will get a blue checkmark once approved.
                                </h1>
                                <img
                                    className='w-24 h-24'
                            ...
                            <div className='flex justify-between border rounded-full px-5 py-3 border-gray-500'>
                                <div>
                                    <span
                                        className={`${paln === "Annually" ? "text-black" : "text-gray-400"} cursor-pointer`}
                                ...
                                <p
                                    ...
                                    className={`${paln === "Monthly" ? "text-black" : "text-gray-400"} cursor-pointer`}
                                >
                                    Monthly
                                </p>
                            </div>
                            ...
                            rounded-full px-5 py-3'>
                                <span className='line-through italic'>$100.00</span>
                                <span className='px-5'> $88.00/year</span>
                            </div>
                        </div>
                    </div>
                </Box>
